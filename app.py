...
if not username or not raw_password:
    ...
    .hero-logo {
        ...
        height: 88px;
        border-radius: 22px;
        background: linear-gradient(135deg, #0F7A5E, #14A97D);
        display: flex;
        align-items: center;
        justify-content: center;
        font-size: 44px;
        margin: 0 auto 20px;
        box-shadow: 0 8px 24px rgba(15, 122, 94, 0.25);
    }
    .hero-title {
        font-size: 40px;
        font-weight: 700;
    ...
    .feature-label { font-size: 13.5px; color: #20242B; font-weight: 600; line-height: 1.4; }
    .hero-cta {
        font-size: 14px;
        color: #5B5F66;
    }
    ...
    <div class="hero-wrap">
        ...
        <div class="hero-title">Teen Budget Tracker</div>
        <div class="hero-sub">Track your money, hit your goals, and see what your spending could really be worth — built by a teen, for teens.</div>
        <div class="free-badge">✨ 100% Free for Teens</div>
        <div class="feature-row">
            <div class="feature-card"><div class="feature-icon">📊</div><div class="feature-label">Track income &amp; spending</div></div>
            <div class="feature-card"><div class="feature-icon">🎯</div><div class="feature-label">Set real savings goals</div></div>
            <div class="feature-card"><div class="feature-icon">📈</div><div class="feature-label">See your money grow</div></div>
        </div>
        <div class="hero-cta">👈 Enter a username and password in the sidebar to get started</div>
    </div>
